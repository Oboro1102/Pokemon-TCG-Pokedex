...
export const Footer = () => {
  ...
  return (
    <Box bg='red.500' w='calc(100% - 24px*2)' py={4} px={6} mx='auto' mb={4} borderRadius='99em' fontSize='xs' display='flex' alignItems='center' justifyContent='space-between' flexWrap='wrap'>
